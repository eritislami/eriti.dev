...
export default function Home({ stars }) {
  return (
    <>
      ...
      <FadeInStagger faster className="mt-12 space-y-12 md:mt-16 md:space-y-16">
        ...
        <Container>
          <FadeIn>
            ...
            <p className="mt-6 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              full-stack solutions for various industries. My passion is to
              strive to deliver powerful, intelligent and easy to use products
              using the latest tools & technologies.
            </p>
          ...
          <FadeIn>
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="mt-6 text-sm text-zinc-600 dark:text-zinc-400">
                  Wether it&apos;s a REST API or a Full-Stack Backend my bread
                  and butter always includes <strong>Laravel</strong>, I love
                  pairing <strong>Laravel</strong> with <strong>React</strong>{' '}
                  via <strong>Inertia.js</strong> or using{' '}
                  <strong>Next.js</strong> for serious front-end projects. The
                  glue that brings everything toghether for me is{' '}
                  <strong>Tailwind</strong>, it has become my exclusive way of
                  writing CSS ever since I first started using it.
                </p>
              </div>
            </div>
          </FadeIn>
